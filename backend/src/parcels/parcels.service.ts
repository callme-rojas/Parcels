...
> = {
  'SCZ-PQA': {
    originAddress: 'Terminal Bimodal Santa Cruz, Bolivia',
    destinationAddress: 'Terminal Puerto Quijarro, Bolivia',
    originLat: -17.789187255491594,
    originLng: -63.162212227495424,
    destinationLat: -19.010028580919684,
    destinationLng: -57.73605286681477,
  },
  'SCZ-SJC': {
    originAddress: 'Terminal Bimodal Santa Cruz, Bolivia',
    destinationAddress: 'Terminal San José de Chiquitos, Bolivia',
    originLat: -17.789187255491594,
    originLng: -63.162212227495424,
    destinationLat: -17.821017140143574,
    destinationLng: -60.74397685301761,
  },
  'SCZ-ROB': {
    originAddress: 'Terminal Bimodal Santa Cruz, Bolivia',
    destinationAddress: 'Terminal Roboré, Bolivia',
    originLat: -17.789187255491594,
    originLng: -63.162212227495424,
    destinationLat: -18.346763244843352,
    destinationLng: -59.758742688516655,
  },
  'PQA-SCZ': {
    originAddress: 'Terminal Puerto Quijarro, Bolivia',
    destinationAddress: 'Terminal Bimodal Santa Cruz, Bolivia',
    originLat: -19.010028580919684,
    originLng: -57.73605286681477,
    destinationLat: -17.789187255491594,
    destinationLng: -63.162212227495424,
  },
};
